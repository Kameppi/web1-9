...
public class GameDirector : MonoBehaviour {
	...
	void Update () {
        ...
        if (this.time < 0)
        {
            ...
            this.generator.GetComponent<ItemGenerator>().SetParameter(0.4f, -0.1f, 2);
            ...
            this.generator.GetComponent<ItemGenerator>().SetParameter(0.1f, -0.04f, 4);
        }else if (0 <= this.time && this.time < 30){
            this.generator.GetComponent<ItemGenerator>().SetParameter(1.0f, -0.04f, 2);
        }
